...
public class edit_gem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_gem);

        Intent i = getIntent();

        //Values from view page on click
        String id = i.getStringExtra("gemName").toString();
        String BrandName = i.getStringExtra("gemWeight").toString();
        String SellerName = i.getStringExtra("gemShape").toString();
        String Address = i.getStringExtra("PricePerCarat").toString();
        String CNo = i.getStringExtra("gemPrice").toString();
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(edit_gem.this, View_Inventory.class);
